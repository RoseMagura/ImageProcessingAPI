...
it('Checking that posting succesfully processes image', function (done) { return __awaiter(void 0, void 0, void 0, function () {
    var res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, request.post('/?name=palmtunnel&width=300&height=500')];
            case 1:
                res = _a.sent();
                expect(res.status).toBe(200);
                return [2 /*return*/];
